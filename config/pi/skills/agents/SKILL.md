...
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --task "Review security"
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"

# Persistent custom agents
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --task "Security review" --save
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --list-saved
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --load "security-expert-skeptical-thorough"
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --delete "security-expert-skeptical-thorough"

# Other options
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --list
bun run ~/.pi/agent/skills/agents/Tools/ComposeAgent.ts --output json
```
