...
## Milestone 15 — pi.dev Harness Support
*Extend Holocron's harness-agnostic layer to run under the [pi.dev](https://pi.dev/) minimal terminal coding agent — proving the config layer is truly harness-portable beyond Claude Code and OpenCode.*
