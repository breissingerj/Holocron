...
```bash
# Run an eval suite
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s <suite>

# Log a failure for later conversion
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/FailureToTask.ts log "description" -c category -s severity

# Convert failures to test tasks
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/FailureToTask.ts convert-all

# Manage suites
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/SuiteManager.ts create <name> -t capability -d "description"
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/SuiteManager.ts list
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/SuiteManager.ts check-saturation <name>
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/SuiteManager.ts graduate <name>
```
...
bun run $HOLOCRON_DIR/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s regression-core -r 3 -u
```
