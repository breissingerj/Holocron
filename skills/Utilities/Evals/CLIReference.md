...
```bash
# Create new use case
bun run $HOLOCRON_DIR/skills/Utilities/Evals/EvalServer/cli.ts use-case create --name <name>

# List all use cases
bun run $HOLOCRON_DIR/skills/Utilities/Evals/EvalServer/cli.ts use-case list
...
bun run $HOLOCRON_DIR/skills/Utilities/Evals/EvalServer/cli.ts test-case add --use-case <name>

# List test cases for use case
bun run $HOLOCRON_DIR/skills/Utilities/Evals/EvalServer/cli.ts test-case list --use-case <name>
```
...
bun run $HOLOCRON_DIR/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name> [--model <model>]
```
...
```bash
cd $HOLOCRON_DIR/skills/Utilities/Evals/EvalServer
...
```
$HOLOCRON_DIR/skills/Utilities/Evals/
├── UseCases/
│   └── <name>/
