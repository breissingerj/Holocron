...
Read and analyze:
- $HOLOCRON_MEMORY_DIR/STATE/current-work.json
...
Analyze:
- $HOLOCRON_DIR/skills/ (installed skills)
...
Run: bun $HOLOCRON_DIR/skills/Utilities/PAIUpgrade/Tools/Anthropic.ts
...
**User Customizations** (`$HOLOCRON_DIR/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`):
