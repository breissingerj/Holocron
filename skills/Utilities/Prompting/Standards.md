...
**Location:** `$HOLOCRON_DIR/skills/Utilities/Fabric/Patterns/`
...
```bash
$HOLOCRON_DIR/skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
All templates live in `$HOLOCRON_DIR/skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun $HOLOCRON_DIR/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '$HOLOCRON_DIR/skills/Utilities/Prompting/Tools/RenderTemplate.ts';
