...
**Prerequisites:**
- Aphorism database exists at `$HOLOCRON_DIR/skills/aphorisms/Database/aphorisms.md`
...
**Read database:**
```bash
Read $HOLOCRON_DIR/skills/aphorisms/Database/aphorisms.md
```
...
Edit(
  file_path=$HOLOCRON_DIR/skills/aphorisms/Database/aphorisms.md,
