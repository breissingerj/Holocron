...
1. Read the skill system documentation: `$HOLOCRON_DIR/SkillSystem.md`
2. Read the canonical example: `$HOLOCRON_DIR/skills/Research/SKILL.md`
...
```bash
mkdir -p $HOLOCRON_DIR/skills/[SkillName]/Workflows
mkdir -p $HOLOCRON_DIR/skills/[SkillName]/Tools
```

**Example:**
```bash
mkdir -p $HOLOCRON_DIR/skills/YourSkill/Workflows
mkdir -p $HOLOCRON_DIR/skills/YourSkill/Tools
```
...
**Full documentation:** `$HOLOCRON_DIR/THENOTIFICATIONSYSTEM.md`
...
```bash
touch $HOLOCRON_DIR/skills/[SkillName]/Workflows/[WorkflowName].md
```
...
**Reference:** `$HOLOCRON_DIR/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch $HOLOCRON_DIR/skills/YourSkill/Workflows/UpdateDaemonInfo.md
touch $HOLOCRON_DIR/skills/YourSkill/Workflows/UpdatePublicRepo.md
touch $HOLOCRON_DIR/skills/YourSkill/Workflows/Create.md
touch $HOLOCRON_DIR/skills/YourSkill/Workflows/Publish.md
```
...
Run this check:
```bash
ls $HOLOCRON_DIR/skills/[SkillName]/
ls $HOLOCRON_DIR/skills/[SkillName]/Workflows/
ls $HOLOCRON_DIR/skills/[SkillName]/Tools/
```
