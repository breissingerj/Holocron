...
**Before creating ANY skill, READ:** `$HOLOCRON_DIR/SkillSystem.md`

**Canonical example to follow:** `$HOLOCRON_DIR/skills/Research/SKILL.md`
...
**See:** `$HOLOCRON_DIR/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `$HOLOCRON_DIR/SkillSystem.md` (Dynamic Loading Pattern section)
