...
PATTERN_PATH="${HOLOCRON_MEMORY_DIR}/skills/Utilities/Fabric/Patterns/$PATTERN_NAME/system.md"
...
if [ -f "$PATTERN_PATH" ]; then
  ...
  ls $HOLOCRON_DIR/skills/Fabric/Patterns/ | head -20
fi
```
...
**Pattern not found:**
```
Pattern '[name]' not found in $HOLOCRON_DIR/skills/Fabric/Patterns/
