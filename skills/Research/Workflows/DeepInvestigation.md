...
```
$HOLOCRON_MEMORY_DIR/RESEARCH/{YYYY-MM}/{YYYY-MM-DD}_{topic-slug}/
```

Read `$HOLOCRON_MEMORY_DIR/STATE/current-work.json` for the active work directory.
...
Templates live at `$HOLOCRON_DIR/skills/Research/Templates/{DomainName}.md`
