...
**Reference:** `$HOLOCRON_DIR/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see $HOLOCRON_DIR/tools/bin/{{CLI_NAME}}/README.md
...
See: $HOLOCRON_DIR/tools/bin/{{CLI_NAME}}/README.md
```
...
**Validation Commands:**
```bash
cd $HOLOCRON_DIR/tools/bin/{{CLI_NAME}}/
chmod +x {{CLI_NAME}}.ts
./{{CLI_NAME}}.ts --help
./{{CLI_NAME}}.ts --version
```
...
**Report to user:**
```
✅ CLI Created: $HOLOCRON_DIR/tools/bin/{{CLI_NAME}}/
...
Documentation: $HOLOCRON_DIR/tools/bin/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
✅ CLI Created: $HOLOCRON_DIR/tools/bin/notioncli/
...
3. Read: $HOLOCRON_DIR/tools/bin/notioncli/README.md
...
Use proven structure from $HOLOCRON_DIR/tools/bin/llcli/ as reference.
