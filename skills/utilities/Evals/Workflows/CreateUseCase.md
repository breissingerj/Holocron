...
```bash
mkdir -p $HOLOCRON_DIR/skills/utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `$HOLOCRON_DIR/skills/utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `$HOLOCRON_DIR/skills/utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `$HOLOCRON_DIR/skills/utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `$HOLOCRON_DIR/skills/utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run $HOLOCRON_DIR/skills/utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la $HOLOCRON_DIR/skills/utilities/Evals/UseCases/<name>/

# Validate config
bun run $HOLOCRON_DIR/skills/utilities/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run $HOLOCRON_DIR/skills/utilities/Evals/EvalServer/cli-run.ts \
  --use-case <name> \
  --test-id 001-basic \
  --verbose
```
