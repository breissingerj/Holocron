...
**Primary Skill:** `$HOLOCRON_DIR/skills/Fabric/SKILL.md`
...
**Patterns Location:** `$HOLOCRON_DIR/skills/Fabric/Patterns/` (237 patterns)
...
-> Runs fabric -U
-> Syncs to $HOLOCRON_DIR/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ $HOLOCRON_DIR/skills/Fabric/Patterns/
```
...
- **Full Skill:** `$HOLOCRON_DIR/skills/Fabric/SKILL.md`
- **Pattern Execution:** `$HOLOCRON_DIR/skills/Fabric/Workflows/ExecutePattern.md`
- **Pattern Updates:** `$HOLOCRON_DIR/skills/Fabric/Workflows/UpdatePatterns.md`
- **All Patterns:** `$HOLOCRON_DIR/skills/Fabric/Patterns/`
