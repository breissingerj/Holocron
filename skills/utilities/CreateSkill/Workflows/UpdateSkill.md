...
```bash
$HOLOCRON_DIR/skills/[SkillName]/SKILL.md
```
...
```bash
touch $HOLOCRON_DIR/skills/[SkillName]/Tools/ToolName.ts
touch $HOLOCRON_DIR/skills/[SkillName]/Tools/ToolName.help.md
```
