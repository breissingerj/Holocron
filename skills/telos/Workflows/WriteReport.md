...
cp -r $HOLOCRON_DIR/skills/telos/ReportTemplate/* {output_dir}/
...
```
$HOLOCRON_DIR/skills/telos/ReportTemplate/
```
...
Edit files in `$HOLOCRON_DIR/skills/telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `$HOLOCRON_DIR/skills/telos/ReportTemplate/app/globals.css`
