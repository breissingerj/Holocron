...
```bash
cp -r $HOLOCRON_DIR/skills/telos/dashboard-template /path/to/your/project
...
- Searches `$HOLOCRON_DIR/skills/telos/` for `.md` files
- Searches `$HOLOCRON_DIR/skills/telos/data/` for `.csv` files
