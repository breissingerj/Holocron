...
- World models must exist at `$HOLOCRON_MEMORY_DIR/RESEARCH/WorldModels/`
...
```
Check $HOLOCRON_MEMORY_DIR/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `$HOLOCRON_MEMORY_DIR/RESEARCH/WorldModels/`.
