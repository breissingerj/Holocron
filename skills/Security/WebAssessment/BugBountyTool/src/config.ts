...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '$HOLOCRON_DIR/skills/hacking/bug-bounties',
    state: '$HOLOCRON_DIR/skills/hacking/bug-bounties/state.json',
    cache: '$HOLOCRON_DIR/skills/hacking/bug-bounties/cache',
    logs: '$HOLOCRON_DIR/skills/hacking/bug-bounties/logs',
  },
