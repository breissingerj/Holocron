...
bun run $HOLOCRON_DIR/skills/Security/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run $HOLOCRON_DIR/skills/Security/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run $HOLOCRON_DIR/skills/Security/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
