...
Reports saved to:
- **Work directory** (`$HOLOCRON_MEMORY_DIR/WORK/{current_work}/`) - For iterative artifacts during investigation
- **MEMORY/RESEARCH/** (`$HOLOCRON_MEMORY_DIR/RESEARCH/YYYY-MM/`) - For pentest engagements and formal assessments
...
Assistant: Activating recon skill with passive-recon workflow.
     ...
     Report: $HOLOCRON_MEMORY_DIR/WORK/{current_work}/recon-example-com/
```
...
**Security Skills:**
- `$HOLOCRON_DIR/skills/Investigation/` - Entity and people reconnaissance (OSINT)
- `$HOLOCRON_DIR/skills/Security/WebAssessment/` - Web application testing
