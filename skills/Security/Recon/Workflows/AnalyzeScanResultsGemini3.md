...
SCAN_FILE=$HOLOCRON_MEMORY_DIR/WORK/${WORK_DIR}/$(date +%Y-%m-%d)_nmap-scan.txt
...
// Usage: bun run tools/batch-scan-analysis.ts $HOLOCRON_MEMORY_DIR/WORK/{current_work}/target-scans/
```
