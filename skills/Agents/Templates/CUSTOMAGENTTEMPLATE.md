...
- **Built-in agents** (`$HOLOCRON_MEMORY_DIR/agents/*.md`): Use this format for the persona section
- **Custom agents** (`$HOLOCRON_MEMORY_DIR/custom-agents/*.md`): Use this format for the entire file
...
|--------|-------------------------|-------------------------------|
| Location | `$HOLOCRON_MEMORY_DIR/agents/` | `$HOLOCRON_MEMORY_DIR/custom-agents/` |
