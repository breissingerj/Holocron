...
- **Holocron/USER/CONSTITUTION.md** - Foundational architectural principles
- **Holocron/USER/CoreStack.md** - Stack preferences (TypeScript > Python, bun > npm, etc.)
- **Holocron/USER/Architecture.md** - PAI's system architecture patterns
