...
**Patterns Location:** `$HOLOCRON_DIR/skills/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `$HOLOCRON_DIR/skills/Fabric/`.
...
```bash
ls $HOLOCRON_DIR/skills/Fabric/Patterns/
```
...
**Full Pattern List:** `ls $HOLOCRON_DIR/skills/Fabric/Patterns/`
**Fabric Skill:** `$HOLOCRON_DIR/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `$HOLOCRON_DIR/skills/Fabric/Patterns/official_pattern_template/`
