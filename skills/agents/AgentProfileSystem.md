...
bun run $HOLOCRON_DIR/skills/agents/Tools/LoadAgentContext.ts Architect "Design new skill system"
```
...
1. Create `[AgentType]Context.md` in `$HOLOCRON_DIR/skills/agents/`
