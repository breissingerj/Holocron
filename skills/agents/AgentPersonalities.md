...
**What happens:**
1. Run `bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts` for EACH agent
...
- Trait definitions: `$HOLOCRON_DIR/skills/agents/Data/Traits.yaml`
- Agent template: `$HOLOCRON_DIR/skills/agents/Templates/DynamicAgent.hbs`
- Composition tool: `$HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts`

---

## Named Agent Architecture

- **Location**: Individual agent files in `$HOLOCRON_MEMORY_DIR/agents/*.md`
