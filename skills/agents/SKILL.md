...
```
$HOLOCRON_MEMORY_DIR/Holocron/USER/SKILLCUSTOMIZATIONS/Agents/
...
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --task "Review security"
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"

# Persistent custom agents
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --task "Security review" --save
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --list-saved
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --load "security-expert-skeptical-thorough"
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --delete "security-expert-skeptical-thorough"

# Other options
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --list
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts --output json
```
