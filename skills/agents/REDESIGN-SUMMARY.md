...
Old YAML system backed up to: `$HOLOCRON_MEMORY_DIR/History/Backups/2025-12-18-AgentProfiles/`
...
- **Holocron/USER/CoreStack.md** - Stack preferences
...
bun run $HOLOCRON_DIR/skills/agents/Tools/LoadAgentContext.ts
# Output: Architect, Artist, Engineer, Designer, QATester

# View specific context
bun run $HOLOCRON_DIR/skills/agents/Tools/LoadAgentContext.ts Architect

# Generate enriched prompt
bun run $HOLOCRON_DIR/skills/agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
