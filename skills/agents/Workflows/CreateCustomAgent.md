...
bun run $HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts \
...
- ComposeAgent tool: `$HOLOCRON_DIR/skills/agents/Tools/ComposeAgent.ts`
- Voice mappings: `$HOLOCRON_DIR/skills/agents/AgentPersonalities.md`
