...
bun $HOLOCRON_DIR/skills/security/Recon/Tools/CorporateStructure.ts target.com

# Subdomain enumeration
bun $HOLOCRON_DIR/skills/security/Recon/Tools/SubdomainEnum.ts target.com

# Endpoint discovery from JavaScript
bun $HOLOCRON_DIR/skills/security/Recon/Tools/EndpointDiscovery.ts https://target.com

# Port scanning
bun $HOLOCRON_DIR/skills/security/Recon/Tools/PortScan.ts target.com

# Path discovery
bun $HOLOCRON_DIR/skills/security/Recon/Tools/PathDiscovery.ts https://target.com
```
