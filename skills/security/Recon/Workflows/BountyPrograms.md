...
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts list

# Show only paid bounty programs (not just swag)
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts list --bounty-only

# Search for programs by keyword
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts search "crypto"
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts search "finance"
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts search "cloud"

# Check if a domain has a bounty program
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts check example.com

# Update local cache from sources
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts update

# Export as JSON
bun $HOLOCRON_DIR/skills/security/Recon/Tools/BountyPrograms.ts list --json > bounty-programs.json
```
...
Local cache stored at: `$HOLOCRON_DIR/skills/security/Recon/Data/BountyPrograms.json`
