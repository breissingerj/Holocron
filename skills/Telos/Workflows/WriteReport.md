...
cp -r ~/.config/opencode/skills/Telos/ReportTemplate/* {output_dir}/
...
```
~/.config/opencode/skills/Telos/ReportTemplate/
```
...
Edit files in `~/.config/opencode/skills/Telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `~/.config/opencode/skills/Telos/ReportTemplate/app/globals.css`
