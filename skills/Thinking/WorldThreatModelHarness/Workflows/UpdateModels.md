...
- Model template at `$HOLOCRON_DIR/skills/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read $HOLOCRON_MEMORY_DIR/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `$HOLOCRON_MEMORY_DIR/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `$HOLOCRON_MEMORY_DIR/RESEARCH/WorldModels/INDEX.md`:
