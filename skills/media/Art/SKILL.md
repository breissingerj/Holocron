...
`$HOLOCRON_MEMORY_DIR/Holocron/USER/SKILLCUSTOMIZATIONS/Art/`
...
**Load from:** `$HOLOCRON_MEMORY_DIR/Holocron/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `$HOLOCRON_MEMORY_DIR/Holocron/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
...
bun run $HOLOCRON_DIR/skills/media/Art/Tools/Generate.ts \
...
**API keys in:** `${HOLOCRON_MEMORY_DIR}/.env`
