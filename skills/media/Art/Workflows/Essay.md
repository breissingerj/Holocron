...
```bash
Read $HOLOCRON_DIR/skills/media/Art/SKILL.md
```
...
bun run $HOLOCRON_DIR/skills/art/Tools/Generate.ts \
...
bun $HOLOCRON_MEMORY_DIR/PAI/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun $HOLOCRON_MEMORY_DIR/PAI/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `$HOLOCRON_DIR/skills/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in $HOLOCRON_MEMORY_DIR/PAI/aesthetic.md
