...
3. **Use Theme Constants:**
   ```
   $HOLOCRON_DIR/skills/Remotion/Tools/Theme.ts
   ```

4. **Reference images** (when visual style reference needed):
   ```
   $HOLOCRON_DIR/skills/media/Art/Examples/
   ```

## PAI Theme Quick Reference

```typescript
import { PAI_THEME } from '$HOLOCRON_DIR/skills/Remotion/Tools/Theme'
...
```typescript
import { PAI_THEME, titleScreenStyle, fadeInterpolation } from '$HOLOCRON_DIR/skills/Remotion/Tools/Theme'
