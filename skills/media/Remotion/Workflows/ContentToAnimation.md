...
# Load: $HOLOCRON_DIR/skills/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from '$HOLOCRON_DIR/skills/Remotion/theme'
...
- Reference: `$HOLOCRON_DIR/skills/Remotion/theme.ts`
