...
const HOLOCRON_DIR = process.env.HOLOCRON_MEMORY_DIR || join(process.env.HOME!, 'Projects', 'personalProjects', 'holocron-context');
const CREATE_UPDATE_SCRIPT = join(HOLOCRON_DIR, 'skills/_SYSTEM/Tools/CreateUpdate.ts');
