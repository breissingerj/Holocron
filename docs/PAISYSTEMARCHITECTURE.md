...
```
PRIVATE: $HOLOCRON_MEMORY_DIR/                    PUBLIC: ${PROJECTS_DIR}/PAI/
...
|----------|-------------|----------|
| **Integrity Audits** | 16 parallel agents verify broken references across ${HOLOCRON_MEMORY_DIR} | `PrivateSystemAudit.md` |
...
|-----------|----------|------------------|
| `Holocron/USER/` | Personal data, finances, health, contacts | RESTRICTED |
