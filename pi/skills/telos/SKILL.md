...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `$HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `$HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/` |
...
```
$HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/
```
...
All files located in `$HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/`:
...
```bash
# View specific file
read $HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/GOALS.md
read $HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/BELIEFS.md

# View recent updates
read $HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `$HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `$HOLOCRON_MEMORY_DIR/Holocron/USER/TELOS/` (in the CORE USER directory)
