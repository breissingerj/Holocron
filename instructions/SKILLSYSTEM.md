...
- `$HOLOCRON_MEMORY_DIR/Holocron/USER/CONTACTS.md` - Contact information
- `$HOLOCRON_MEMORY_DIR/Holocron/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`$HOLOCRON_MEMORY_DIR/Holocron/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
$HOLOCRON_MEMORY_DIR/Holocron/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p $HOLOCRON_MEMORY_DIR/Holocron/USER/SKILLCUSTOMIZATIONS/SkillName`
...
5. Move backups to `$HOLOCRON_MEMORY_DIR/Backups/`
