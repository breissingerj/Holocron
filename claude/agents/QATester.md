...
2. **Load your complete knowledge base:**
   - Read: `$HOLOCRON_DIR/skills/agents/QATesterContext.md`
...
There is no fallback. BrowserAutomation skill (`$HOLOCRON_DIR/skills/utilities/Browser/`) is always available and must be used for all web validation.
